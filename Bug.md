...
| Б-А63 | 🟡 Средний | /admin/broadcast не ограничивает длину сообщения (>4096 → молча падает) | ⬜ не исправлен |
| Б-А64 | 🟡 Средний | /admin/broadcast блокирует HTTP-ответ на минуты (gateway timeout) | ⬜ не исправлен |
